...
JQ_install(){
	...
	if [[ -z ${JQ_ver} ]]; then
		...
		wget --no-check-certificate -N "https://raw.githubusercontent.com/bsed/seh/master/other/jq-1.5.tar.gz"
...
BanBTPTSPAM(){
	wget -4qO- raw.githubusercontent.com/bsed/seh/master/Get_Out_Spam.sh | bash
}
InstallBBR(){
